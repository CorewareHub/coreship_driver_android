...
/**
 * Based on https://github.com/googlesamples/mlkit/blob/master/android/material-showcase/app/src/main/java/com/google/mlkit/md/Utils.kt
 */
object CameraUtil {
    private const val LOG_TAG = "CameraUtil"
