...
/**
 * Based on https://github.com/googlesamples/mlkit/blob/master/android/material-showcase/app/src/main/java/com/google/mlkit/md/camera/WorkflowModel.kt
 *
...
class WorkflowModel(application: Application) : AndroidViewModel(application) {
    ...
    fun confirmingObject(confirmingObject: DetectedObjectInfo, progress: Float) {
        ...
        if (isConfirmed) {
            ...
            if (SharedPreferencesUtil.isAutoSearchEnabled(context)) {
