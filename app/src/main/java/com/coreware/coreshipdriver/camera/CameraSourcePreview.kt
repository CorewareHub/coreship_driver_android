...
/**
 * Based on https://github.com/googlesamples/mlkit/blob/master/android/material-showcase/app/src/main/java/com/google/mlkit/md/camera/CameraSourcePreview.kt
 */
class CameraSourcePreview(context: Context, attributeSet: AttributeSet) : FrameLayout(context, attributeSet) {
    ...
    private inner class SurfaceCallback : SurfaceHolder.Callback {
        override fun surfaceCreated(surfaceHolder: SurfaceHolder) {
            ...
            try {
                ...
                Log.e(LOG_TAG, "Could not start camera source.")
            }
        }
