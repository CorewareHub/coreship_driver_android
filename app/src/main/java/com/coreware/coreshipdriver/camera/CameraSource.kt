...
/**
 * Based on https://github.com/googlesamples/mlkit/blob/master/android/material-showcase/app/src/main/java/com/google/mlkit/md/camera/CameraSource.kt
 *
...
class CameraSource(private val graphicOverlay: GraphicOverlay) {
    ...
    private fun setPreviewAndPictureSize(camera: Camera, parameters: Camera.Parameters) {
        ...
        val sizePair: CameraSizePair = SharedPreferencesUtil.getUserSpecifiedPreviewSize(context, camera)
                ?: run {
                    ...
                    val displayAspectRatioInLandscape: Float =
                            if (CameraUtil.isPortraitMode(graphicOverlay.context)) {
        ...
        previewSize = sizePair.preview.also {
            ...
            SharedPreferencesUtil.saveRearCameraPreviewSize(context, it.toString())
        }

        sizePair.picture?.let { pictureSize ->
            Log.v(TAG, "Camera picture size: $pictureSize")
            parameters.setPictureSize(pictureSize.width, pictureSize.height)
            SharedPreferencesUtil.saveRearCameraPictureSize(context, pictureSize.toString());
        }
    }
    ...
    companion object {
        ...
        private fun selectSizePair(camera: Camera, displayAspectRatioInLandscape: Float): CameraSizePair? {
            val validPreviewSizes = CameraUtil.generateValidPreviewSizeList(camera)
            Log.i(TAG, validPreviewSizes.size.toString())
            ...
            for (sizePair in validPreviewSizes) {
                ...
                if (abs(aspectRatioDiff - minAspectRatioDiff) < CameraUtil.ASPECT_RATIO_TOLERANCE) {
