...
/**
 * Based on https://github.com/googlesamples/mlkit/blob/master/android/material-showcase/app/src/main/java/com/google/mlkit/md/barcodedetection/BarcodeProcessor.kt
 *
...
class BarcodeProcessor(graphicOverlay: GraphicOverlay, private val workflowModel: WorkflowModel) :
    ...
    override fun onSuccess(
        ...
        if (barcodeInCenter == null) {
            ...
            val sizeProgress = SharedPreferencesUtil.getProgressToMeetBarcodeSizeRequirement(graphicOverlay.context, graphicOverlay, barcodeInCenter)
            if (sizeProgress < 1) {
                ...
                if (SharedPreferencesUtil.shouldDelayLoadingBarcodeResult(graphicOverlay.context)) {
